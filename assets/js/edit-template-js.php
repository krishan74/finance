<script>
    ...
    $(document).ready(function () {
        ...
        var scheduleAoption = "<?php echo $scheduleAoption; ?>";
        scheduleAoption = parseInt(scheduleAoption);
        ...
        var scheduleAFilename = "<?php echo $scheduleAFilename; ?>";
        ...
        if(scheduleAFilename != "") {
            ...
            base_url + 'assets/temp-schedule-a/' + scheduleAFilename + '"></iframe>';

            document.getElementById('displayUploadedScheduleA').innerHTML = html;
            document.getElementById('uploadedFilename').value = scheduleAFilename;
          ...
          if (this.files && this.files[0]) {
            ...
            FR.addEventListener("load", function(e) {
                try {
                    ...
                    '<img style="margin: 0 auto;" src="' + e.target.result + '">'+
                    '</p>';
                    CKEDITOR.instances[id].setData(content + html);
                } catch(e) {
                    console.log(e);
                }
            }); 
