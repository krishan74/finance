    ...
    $( document ).ready(function() {
        ...
        $(document).on('touchstart click', '.viewTemplate ', function(event){
            ...
            var html = '<iframe frameborder="0" width="100%" height="450px" src="https://view.officeapps.live.com/op/embed.aspx?src=' + 
        			   '<?php echo base_url();?>assets/created-templates/'+filename  + '"></iframe>';

        	document.getElementById('viewAgreementModalBody').innerHTML = html;*/
			//______________________________________________________//
			document.getElementById('viewAgreementModalBody').innerHTML = ''; // Clears the modal body content
    var filename = $(this).data('file');
	var filename="4227-202404262207381489784611-RFP_Form.docx"
    var encodedFilename = filename  // encodeURIComponent(filename); // Encoding the filename to ensure URL is valid
    var baseUrl = '<?php echo base_url(); ?>';
    var fullPath = baseUrl + 'assets/created-templates/' + encodedFilename;
	//var iframeHtml = '<iframe frameborder="0" width="100%" height="450px" src="https://docs.google.com?gview?url=' + fullPath + '"></iframe>';
    var iframeHtml = '<iframe frameborder="0" width="100%" height="450px" src="https://view.officeapps.live.com/op/embed.aspx?src=' + fullPath + '"></iframe>';
		

    document.getElementById('viewAgreementModalBody').innerHTML = iframeHtml; // Sets the new iframe into the modal body
