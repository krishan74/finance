...
<body>
			...
			<div class="row">
				...
				<div class="contentSection">
					<div class="contentSectionInner">
						<?php 
						$attributes = ['id' => 'createClientForm'];	
						echo form_open('client/saveClient', $attributes) ?>

							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<h3>Create Party (Indivisual/Company)</h3>
								</div>
							...
							<div class="row">
								...
								<div class="mt-5 col-lg-6 col-md-6 col-sm-12 col-xs-12 text-right">
									<input type="hidden" id="bankCounter" name="bankCounter" value="1">
							...
							<div id="bankDiv">
								...
								<!--Bank Div 1 start -->
								<div id="bankDetail1" class="row rowBankDiv">
									<div class="mt-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
										<lable>Beneficiary<span class="red">*</span></lable>
									...
									<div class="mt-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
										<lable>IFSC Code <span class="red">*</span></lable>
									...
									<div class="mt-3 col-lg-6 col-md-6 col-sm-12 col-xs-12 text-right">
	                                    <button type="button" onclick="minusBankDiv(1)" class="btn btn-danger">
	                                        Remove</i>
	                                    </button>
                                    </div>									
								</div>	
							...
							<div id="authBlock" class="row">
								<div class="mb-3 col-lg-12 col-md-12 col-sm-12 col-xs-12 firstDiv">
									<h4>Other Signatory</h4>
								</div>
							<?php 
							foreach($AllSignAuth as $key => $value) {
							?>
							<div class="mb-2 col-lg-3 col-md-3 col-sm-12 col-xs-12 repeatedDiv">
								<input type="checkbox" name="signAuthCheckbox[]" value="<?php echo $value['id']; ?>"> 
							...
							<div id="contactPersonDiv" class="w-100">
								...
								<div id="rowContactPersonDiv1" class="row contactPersonClass">
									...
									<div class="mt-3 col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
										<button type="button" onclick="minusContactPerson(1)" class="btn btn-danger" id="">Remove
										</button>
									</div>
								</div>
							</div>
							<div class="row">
							<div class="mt-3 col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<button type="button" id="createClientBtn" class="createUserBtn btn btn-success">Create Client</button> 
							</div>
						</div>						
						</form>
					</div>
	...
	<script>
		$( document ).ready(function() {
			$(document).on('touchstart click', '#createClientBtn', function(event){
				...
				swal({
					title: "Are you sure?",
					text: "You are about to create this Client!",
					icon: "warning",
					buttons: true,
					dangerMode: true,
				})
				.then((willDelete) => {
					if (willDelete) {
						...
						var ajaxUrl = "<?php echo base_url(); ?>" + "client/saveclient";
						$.ajax({
						    url: ajaxUrl,
						    data: formData,
						    type: 'POST',
