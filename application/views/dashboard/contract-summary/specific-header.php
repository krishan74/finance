			...
			<div class="row">
				...
				<div class="contentSection">
					<div class="contentSectionInner">
						<h3 class="mb-4">Contract Summary<a href="<?php echo base_url(); ?>contract/summary"><button type="button" class="ml-3 btn btn-warning">Contract Summary</button></a></h3>
						<table id="viewUsertable" class="display">
						    ...
						    <tbody>
						        <?php foreach (datewise_contracts as $key => $value) { ?>
						        <tr>
									<td>
						        	...
						        	<td class="text-left"><?php echo $value['currentDate']; ?></td>
						        	<td class="text-left"><?php echo $value['templateCode']; ?></td>
